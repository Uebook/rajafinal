...
async def seed():
    ...
    async with async_session_factory() as db:
        ...
        # ── 2. Sample Categories ─────────────────────────────
        categories_data = [
            {"name": "Electronics", "desc": "Electronic devices and accessories", "image": "https://images.unsplash.com/photo-1498049794561-7780e7231661?w=500&q=80"},
            {"name": "Grocery", "desc": "Daily grocery and FMCG products", "image": "https://images.unsplash.com/photo-1542838132-92c53300491e?w=500&q=80"},
            {"name": "Personal Care", "desc": "Personal care and hygiene products", "image": "https://images.unsplash.com/photo-1526947425960-945c6e72858f?w=500&q=80"},
            {"name": "Home & Kitchen", "desc": "Home and kitchen essentials", "image": "https://images.unsplash.com/photo-1556911220-e15b29be8c8f?w=500&q=80"},
        ]
        cat_ids = []
        for cat_data in categories_data:
            ...
            if not existing_cat:
                ...
                if not existing_cat.image_url:
                    existing_cat.image_url = cat_data["image"]
                    await db.flush()
                cat_ids.append(existing_cat.id)
